   ...
   return (
      ...
      <div className="book" style={{ marginBottom: '30px' }}>
         ...
         <Col sm={6} md={4} className="mt-3 .align-items-baseline">
            <Card onClick={() => <Link to="test" />} style={{ width: '14rem', cursor: 'pointer', minHeight: '485px' }} className="bookCard" bg="primary" border="secondary">
               ...
               <Card.Header><b>{props.book.title}</b></Card.Header>
               <Card.Body>
               ...
               <Card.Footer className="text-center"><Button variant="success">Select Book</Button></Card.Footer>
